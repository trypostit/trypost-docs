...
<Steps>
  <Step title="Create your account">
    Sign up at [app.trypost.it/register](https://app.trypost.it/register). Pick a plan and complete checkout — first-time subscribers pay **$1 for the first month**. Verify your email when the link arrives.
  </Step>
