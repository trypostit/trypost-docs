...
A [paused webhook](/knowledge-base/webhooks#status) also emails the account owner. That message is transactional — it is not an in-app notification and has no toggle on this page.
