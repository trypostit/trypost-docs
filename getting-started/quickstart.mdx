...
<Steps>
  <Step title="Create your account">
    Sign up at [app.trypost.it/register](https://app.trypost.it/register). Pick a plan and complete checkout — first-time subscribers get an **8-day free trial** or a **$1 first month**, depending on the current offer. Verify your email when the link arrives.
  </Step>
  <Step title="Create your first workspace">
    After signing in, set up a workspace (one per brand, client, or project). The workspace holds your social accounts, posts, labels, signatures, repurposes, and team members.
  </Step>
