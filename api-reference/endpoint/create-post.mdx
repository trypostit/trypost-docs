...
<ParamField body="content" type="string">
  The post body shared across all platforms. Up to 63 206 characters. Defaults to empty.
</ParamField>

<ParamField body="media" type="array">
  Media items to attach to the post. Each item should match the shape returned by [`POST /posts/{post}/media`](/api-reference/endpoint/attach-media) — `id`, `path`, `url`, `type`, `mime_type`, `original_filename`. Most callers use the dedicated attach-media endpoint instead.
</ParamField>
