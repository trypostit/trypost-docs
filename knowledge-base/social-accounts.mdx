...
<Note>
  Where a platform asks you to pick (LinkedIn identities, Facebook pages, Instagram accounts), anything already connected to this workspace is left out of the list — you can only pick something new. If nothing is left, TryPost says so instead of showing an empty picker.
</Note>
