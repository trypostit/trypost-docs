...
If you are on Socials and try to create a second workspace, the upgrade dialog opens. See [Plans & billing](/knowledge-base/plans-and-billing) for full pricing, trial, and plan-change details. Self-hosted instances skip these checks.
