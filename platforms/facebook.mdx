...
4. Select the page you want to manage. Pages already connected to this workspace are left out of the list, and if only one is left TryPost connects it without asking
