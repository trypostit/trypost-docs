...
<ResponseField name="data" type="array">
  ...
  <Expandable>
    ...
    <ResponseField name="meta" type="object">Extra file data when present: `width`, `height`, `duration`, `alt_text`. `null` or `[]` when nothing was stored. This is media meta, not `platforms[].meta`.</ResponseField>
