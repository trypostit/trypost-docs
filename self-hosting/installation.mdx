...
### 3. Run all dev processes in one terminal
...
### 4. Production process supervisors
...
Visit `http://localhost:8000` (or your configured `APP_URL`) and you should see the TryPost welcome page. Create the first account from `/register` and you'll land in the dashboard.
