...
Each channel or group becomes its own account. How many you can connect depends on [how many accounts per network](/knowledge-base/social-accounts#how-many-accounts-per-network) your instance allows — one on TryPost Cloud, several on a standard self-hosted install.
