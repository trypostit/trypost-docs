...
| **toggle-social-account-tool** | Toggle a social account active/inactive. When inactive, the account is skipped during publishing. Requires manage-accounts (Owner / Admin). |
