...
|----------------|-------|-------|--------|
| `discord_message` | 10 MB | 20 MB | Any allowed upload type. GIF accepted |

Official specs: [Uploading Files](https://docs.discord.com/developers/reference#uploading-files) (20 MiB bot default). Full catalog: [Media](/knowledge-base/media).
