...
<Note>
  This ships off. Self-hosted installs publish through their own X app and pay their own X bill, so the cost this avoids is not necessarily one worth the unclickable links. TryPost Cloud runs with it on.
</Note>
