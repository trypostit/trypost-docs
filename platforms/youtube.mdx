...
| `content_type` | Video | Duration | Format |
|----------------|-------|----------|--------|
| `youtube_short` | 1 GB | 3 minutes | MP4 or MOV |

Official specs: [`videos.insert`](https://developers.google.com/youtube/v3/docs/videos/insert), [3-minute Shorts](https://support.google.com/youtube/answer/15424877). Full catalog: [Media](/knowledge-base/media).
