...
<Steps>
  <Step title="Create your account">
    Sign up at [app.trypost.it](https://app.trypost.it/register) and create your workspace.
  </Step>
  <Step title="Connect your accounts">
    Go to **Accounts** and connect your social media profiles. TryPost supports LinkedIn, X (Twitter), Facebook, Instagram, TikTok, YouTube, Threads, Pinterest, Bluesky, and Mastodon.
