...
<Note>
  MCP access on **TryPost Cloud** requires an active subscription. New accounts pay **$1 for the first month** during welcome. See [Plans & billing](/knowledge-base/plans-and-billing) for details. Self-hosted instances skip this check.
</Note>
...
<AccordionGroup>
  <Accordion title="HTTP 402 — Active subscription required">
    Your OAuth grant is valid and the config is correct — the account behind it just doesn't have an active subscription. Open [app.trypost.it](https://app.trypost.it), pick a plan, then reconnect the MCP server. Self-hosted instances skip this check.
  </Accordion>
...
<CardGroup cols={3}>
  ...
  <Card title="Muse AI Agent" icon="/images/ai/muse.svg" href="/ai/muse">
    Personal agent by Meta.
  </Card>
  <Card title="Muse Code" icon="/images/ai/muse.svg" href="/ai/muse-code">
    CLI assistant by Meta.
  </Card>
