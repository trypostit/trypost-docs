...
|----------------|-------|-------|----------|--------|
| `tiktok_video` | — | 1 GB (Cloud cap; TikTok allows 4 GB) | 10 minutes, or less if `creator_info` says so | MP4 or MOV (TryPost does not accept WebM uploads) |
| `tiktok_photo` | 10 MB | — | — | JPEG/WebP, up to 35 images |

Official specs: [Media Transfer Guide](https://developers.tiktok.com/doc/content-posting-api-media-transfer-guide). Full catalog: [Media](/knowledge-base/media).
