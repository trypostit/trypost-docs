...
Self-hosted instances skip the Cloud subscription check (`SELF_HOSTED=true`), so AI calls go straight to the configured provider — you pay the provider directly.
