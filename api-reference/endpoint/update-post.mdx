...
<ParamField body="platforms" type="array">
  ...
  <Expandable>
    ...
    <ParamField body="content_type" type="string">
      Override the content_type for this platform. Cross-validated against the social account's platform. Discover the live catalog with [`GET /content-types`](/api-reference/endpoint/list-content-types).
