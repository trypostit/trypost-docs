...
Multiple accounts on the same network are always allowed. The `ALLOW_MULTIPLE_SOCIAL_ACCOUNTS` setting was removed — you can delete it from `.env` if it is still there.
