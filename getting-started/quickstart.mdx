...
<Steps>
  <Step title="Create your account">
    Sign up at [app.trypost.it/register](https://app.trypost.it/register). You'll get a **7-day free trial of the Starter plan — no credit card required**. Verify your email when the link arrives.
  </Step>
  ...
  <Step title="Connect your accounts">
    Go to **Accounts** and connect your social media profiles. TryPost supports LinkedIn, X, Facebook, Instagram, TikTok, YouTube, Threads, Pinterest, Bluesky, Mastodon, and Telegram.

    See the [Platforms guide](/platforms/overview) for details on each platform.
  </Step>
...
<Columns cols={3}>
  <Card title="Platforms" icon="share-nodes" href="/platforms/overview">
