...
|----------------|-------|-------|----------|--------|
| `pinterest_pin` | 10 MB | — | — | JPEG/PNG |
| `pinterest_video_pin` | — | 1 GB | 15 minutes | MP4 or MOV |
| `pinterest_carousel` | 10 MB | — | — | JPEG/PNG, 2–5 images |

Official specs: [Creating boards and pins](https://developers.pinterest.com/docs/work-with-organic-content-and-users/create-boards-and-pins/), [Product specs](https://help.pinterest.com/en/business/article/pinterest-product-specs). Full catalog: [Media](/knowledge-base/media).
