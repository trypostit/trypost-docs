...
<Note>
  **Bluesky** and **Mastodon** don't require API credentials — they work out of the box. **Telegram** uses a single shared bot you create with [@BotFather](https://t.me/BotFather), not a per-user OAuth app — see its credentials below.
</Note>
