...
| Tool | Description |
|------|-------------|
| **list-repurpose-source-formats-tool** | List watchable formats (`reel`, `video`, `story`) with localized labels. No input. REST: [`GET /repurpose-source-formats`](/api-reference/endpoint/list-repurpose-source-formats). |
