...
|----------------|-------|-------|----------|--------|
| `x_post` | 5 MB | 1 GB | 20 minutes | JPG/PNG/GIF/WebP; video H.264 (MP4 or MOV) |

These are Post (`tweet_video`) limits. Official specs: [Media best practices](https://docs.x.com/x-api/media/quickstart/best-practices). Full catalog: [Media](/knowledge-base/media).
