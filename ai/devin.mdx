...
- A TryPost Cloud account with an active subscription ([plans and billing](/knowledge-base/plans-and-billing))
...
<AccordionGroup>
  ...
  <Accordion title="HTTP 402 — Active subscription required">
    The OAuth grant worked; the TryPost account is not active. Open [app.trypost.it](https://app.trypost.it), pick a plan, then reconnect. Self-hosted instances skip this check. See [Introduction](/ai/introduction#troubleshooting).
  </Accordion>
