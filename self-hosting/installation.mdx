...
2. Create an API key under workspace Settings → API (fails with 500 if Passport keys or client are missing)
3. Upload a media file (404s if you use `public` disk without `storage:link`)
4. Schedule a test post and confirm Horizon processes it
