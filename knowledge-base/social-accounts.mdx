...
Instagram and Facebook accounts can also be a [repurpose](/knowledge-base/repurposes) source. Switching a source off pauses that flow; switching a destination off only skips that account for each new video.
