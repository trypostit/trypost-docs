...
<ParamField body="media" type="array">
  ...
  Prefer dedicated endpoints when practical: [`POST /posts/{post}/media`](/api-reference/endpoint/upload-media) (multipart file), [`POST /posts/{post}/media/from-url`](/api-reference/endpoint/attach-media-from-url), or [`POST /posts/{post}/media/from-asset`](/api-reference/endpoint/attach-existing-asset) to reuse a library item.
</ParamField>
