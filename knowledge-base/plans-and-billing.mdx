...
A LinkedIn profile and a LinkedIn Page count as **one** network between them, as do Instagram Standalone and Instagram (Facebook Business) — see [how many accounts per network](/knowledge-base/social-accounts#how-many-accounts-per-network).
