...
<Columns cols={2}>
  <Card title="Repurpose" icon="arrows-rotate" href="/knowledge-base/repurposes">
...
<Columns cols={2}>
  ...
  <Card title="Plans &amp; billing" icon="credit-card" href="/knowledge-base/plans-and-billing">
    Cloud plans, the $1 first month, and managing your subscription.
  </Card>
  ...
  <Card title="Webhooks" icon="webhook" href="/knowledge-base/webhooks">
...
<Columns cols={2}>
  <Card title="REST API" icon="code" href="/api-reference/introduction">
    Manage posts, signatures, labels, accounts, repurposes, webhooks, and API keys programmatically.
  </Card>
